...
/***/ "./src/libs/@form-validation/umd/validator-phone/index.min.js":
/*!********************************************************************!*\
  !*** ./src/libs/@form-validation/umd/validator-phone/index.min.js ***!
  \********************************************************************/
/***/ (function(module, exports, __webpack_require__) {

eval("var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\n/** \n * FormValidation (https://formvalidation.io)\n * The best validation library for JavaScript\n * (c) 2013 - 2023 Nguyen Huu Phuoc <me@phuoc.ng>\n *\n * @license https://formvalidation.io/license\n * @package @form-validation/validator-phone\n * @version 2.4.0\n */\n\n!function (s, e) {\n  \"object\" == ( false ? 0 : _typeof(exports)) && \"undefined\" != \"object\" ? module.exports = e(__webpack_require__(/*! @form-validation/core */ \"./node_modules/@form-validation/core/lib/index.js\")) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! @form-validation/core */ \"./node_modules/@form-validation/core/lib/index.js\")], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?\n\t\t(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (0);\n}(this, function (s) {\n  \"use strict\";\n\n  var e = s.utils.format,\n    t = s.utils.removeUndefined;\n  return function () {\n    var s = [\"AE\", \"BG\", \"BR\", \"CN\", \"CZ\", \"DE\", \"DK\", \"ES\", \"FR\", \"GB\", \"IN\", \"MA\", \"NL\", \"PK\", \"RO\", \"RU\", \"SK\", \"TH\", \"US\", \"VE\"];\n    return {\n      validate: function validate(a) {\n        if (\"\" === a.value) return {\n          valid: !0\n        };\n        var d = Object.assign({}, {\n            message: \"\"\n          }, t(a.options)),\n          r = a.value.trim(),\n          o = r.substr(0, 2);\n        if (!(o = \"function\" == typeof d.country ? d.country.call(this) : d.country) || -1 === s.indexOf(o.toUpperCase())) return {\n          valid: !0\n        };\n        var n = !0;\n        switch (o.toUpperCase()) {\n          case \"AE\":\n            n = /^(((\\+|00)?971[\\s.-]?(\\(0\\)[\\s.-]?)?|0)(\\(5(0|2|5|6)\\)|5(0|2|5|6)|2|3|4|6|7|9)|60)([\\s.-]?[0-9]){7}$/.test(r);\n            break;\n          case \"BG\":\n            n = /^(0|359|00)(((700|900)[0-9]{5}|((800)[0-9]{5}|(800)[0-9]{4}))|(87|88|89)([0-9]{7})|((2[0-9]{7})|(([3-9][0-9])(([0-9]{6})|([0-9]{5})))))$/.test(r.replace(/\\+|\\s|-|\\/|\\(|\\)/gi, \"\"));\n            break;\n          case \"BR\":\n            n = /^(([\\d]{4}[-.\\s]{1}[\\d]{2,3}[-.\\s]{1}[\\d]{2}[-.\\s]{1}[\\d]{2})|([\\d]{4}[-.\\s]{1}[\\d]{3}[-.\\s]{1}[\\d]{4})|((\\(?\\+?[0-9]{2}\\)?\\s?)?(\\(?\\d{2}\\)?\\s?)?\\d{4,5}[-.\\s]?\\d{4}))$/.test(r);\n            break;\n          case \"CN\":\n            n = /^((00|\\+)?(86(?:-| )))?((\\d{11})|(\\d{3}[- ]{1}\\d{4}[- ]{1}\\d{4})|((\\d{2,4}[- ]){1}(\\d{7,8}|(\\d{3,4}[- ]{1}\\d{4}))([- ]{1}\\d{1,4})?))$/.test(r);\n            break;\n          case \"CZ\":\n            n = /^(((00)([- ]?)|\\+)(420)([- ]?))?((\\d{3})([- ]?)){2}(\\d{3})$/.test(r);\n            break;\n          case \"DE\":\n            n = /^(((((((00|\\+)49[ \\-/]?)|0)[1-9][0-9]{1,4})[ \\-/]?)|((((00|\\+)49\\()|\\(0)[1-9][0-9]{1,4}\\)[ \\-/]?))[0-9]{1,7}([ \\-/]?[0-9]{1,5})?)$/.test(r);\n            break;\n          case \"DK\":\n            n = /^(\\+45|0045|\\(45\\))?\\s?[2-9](\\s?\\d){7}$/.test(r);\n            break;\n          case \"ES\":\n            n = /^(?:(?:(?:\\+|00)34\\D?))?(?:5|6|7|8|9)(?:\\d\\D?){8}$/.test(r);\n            break;\n          case \"FR\":\n            n = /^(?:(?:(?:\\+|00)33[ ]?(?:\\(0\\)[ ]?)?)|0){1}[1-9]{1}([ .-]?)(?:\\d{2}\\1?){3}\\d{2}$/.test(r);\n            break;\n          case \"GB\":\n            n = /^\\(?(?:(?:0(?:0|11)\\)?[\\s-]?\\(?|\\+)44\\)?[\\s-]?\\(?(?:0\\)?[\\s-]?\\(?)?|0)(?:\\d{2}\\)?[\\s-]?\\d{4}[\\s-]?\\d{4}|\\d{3}\\)?[\\s-]?\\d{3}[\\s-]?\\d{3,4}|\\d{4}\\)?[\\s-]?(?:\\d{5}|\\d{3}[\\s-]?\\d{3})|\\d{5}\\)?[\\s-]?\\d{4,5}|8(?:00[\\s-]?11[\\s-]?11|45[\\s-]?46[\\s-]?4\\d))(?:(?:[\\s-]?(?:x|ext\\.?\\s?|#)\\d+)?)$/.test(r);\n            break;\n          case \"IN\":\n            n = /((\\+?)((0[ -]+)*|(91 )*)(\\d{12}|\\d{10}))|\\d{5}([- ]*)\\d{6}/.test(r);\n            break;\n          case \"MA\":\n            n = /^(?:(?:(?:\\+|00)212[\\s]?(?:[\\s]?\\(0\\)[\\s]?)?)|0){1}(?:5[\\s.-]?[2-3]|6[\\s.-]?[13-9]){1}[0-9]{1}(?:[\\s.-]?\\d{2}){3}$/.test(r);\n            break;\n          case \"NL\":\n            n = /^((\\+|00(\\s|\\s?-\\s?)?)31(\\s|\\s?-\\s?)?(\\(0\\)[-\\s]?)?|0)[1-9]((\\s|\\s?-\\s?)?[0-9])((\\s|\\s?-\\s?)?[0-9])((\\s|\\s?-\\s?)?[0-9])\\s?[0-9]\\s?[0-9]\\s?[0-9]\\s?[0-9]\\s?[0-9]$/gm.test(r);\n            break;\n          case \"PK\":\n            n = /^0?3[0-9]{2}[0-9]{7}$/.test(r);\n            break;\n          case \"RO\":\n            n = /^(\\+4|)?(07[0-8]{1}[0-9]{1}|02[0-9]{2}|03[0-9]{2}){1}?(\\s|\\.|-)?([0-9]{3}(\\s|\\.|-|)){2}$/g.test(r);\n            break;\n          case \"RU\":\n            n = /^((8|\\+7|007)[-./ ]?)?([(/.]?\\d{3}[)/.]?[-./ ]?)?[\\d\\-./ ]{7,10}$/g.test(r);\n            break;\n          case \"SK\":\n            n = /^(((00)([- ]?)|\\+)(421)([- ]?))?((\\d{3})([- ]?)){2}(\\d{3})$/.test(r);\n            break;\n          case \"TH\":\n            n = /^0\\(?([6|8-9]{2})*-([0-9]{3})*-([0-9]{4})$/.test(r);\n            break;\n          case \"VE\":\n            n = /^0(?:2(?:12|4[0-9]|5[1-9]|6[0-9]|7[0-8]|8[1-35-8]|9[1-5]|3[45789])|4(?:1[246]|2[46]))\\d{7}$/.test(r);\n            break;\n          default:\n            n = /^(?:(1-?)|(\\+1 ?))?\\(?\\d{3}\\)?[-.\\s]?\\d{3}[-.\\s]?\\d{4}$/.test(r);\n        }\n        return {\n          message: e(a.l10n && a.l10n.phone ? d.message || a.l10n.phone.country : d.message, a.l10n && a.l10n.phone && a.l10n.phone.countries ? a.l10n.phone.countries[o] : o),\n          valid: n\n        };\n      }\n    };\n  };\n});\n\n//# sourceURL=webpack://Vuexy/./src/libs/@form-validation/umd/validator-phone/index.min.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/libs/@form-validation/umd/validator-phone/index.min.js");
/******/ 	
