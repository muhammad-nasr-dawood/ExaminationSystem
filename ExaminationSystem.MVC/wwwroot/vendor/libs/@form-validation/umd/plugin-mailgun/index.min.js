...
/***/ "./node_modules/@form-validation/plugin-alias/lib/cjs/index.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@form-validation/plugin-alias/lib/cjs/index.js ***!
  \*********************************************************************/
...
"use strict";
eval("/**\n * FormValidation (https://formvalidation.io)\n * The best validation library for JavaScript\n * (c) 2013 - 2023 Nguyen Huu Phuoc <me@phuoc.ng>\n */\n\n\n\nif (false) {} else {\n    module.exports = __webpack_require__(/*! ./cjs/index.js */ \"./node_modules/@form-validation/plugin-alias/lib/cjs/index.js\");\n}\n\n\n//# sourceURL=webpack://Vuexy/./node_modules/@form-validation/plugin-alias/lib/index.js?");

/***/ }),

/***/ "./src/libs/@form-validation/umd/plugin-mailgun/index.min.js":
/*!*******************************************************************!*\
  !*** ./src/libs/@form-validation/umd/plugin-mailgun/index.min.js ***!
  \*******************************************************************/
/***/ (function(module, exports, __webpack_require__) {

eval("var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;function _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\n/** \n * FormValidation (https://formvalidation.io)\n * The best validation library for JavaScript\n * (c) 2013 - 2023 Nguyen Huu Phuoc <me@phuoc.ng>\n *\n * @license https://formvalidation.io/license\n * @package @form-validation/plugin-mailgun\n * @version 2.4.0\n */\n\n!function (e, i) {\n  \"object\" == ( false ? 0 : _typeof(exports)) && \"undefined\" != \"object\" ? module.exports = i(__webpack_require__(/*! @form-validation/core */ \"./node_modules/@form-validation/core/lib/index.js\"), __webpack_require__(/*! @form-validation/plugin-alias */ \"./node_modules/@form-validation/plugin-alias/lib/index.js\")) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! @form-validation/core */ \"./node_modules/@form-validation/core/lib/index.js\"), __webpack_require__(/*! @form-validation/plugin-alias */ \"./node_modules/@form-validation/plugin-alias/lib/index.js\")], __WEBPACK_AMD_DEFINE_FACTORY__ = (i),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?\n\t\t(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),\n\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (0);\n}(this, function (e, i) {\n  \"use strict\";\n\n  var _t = function t(e, i) {\n    return _t = Object.setPrototypeOf || {\n      __proto__: []\n    } instanceof Array && function (e, i) {\n      e.__proto__ = i;\n    } || function (e, i) {\n      for (var t in i) Object.prototype.hasOwnProperty.call(i, t) && (e[t] = i[t]);\n    }, _t(e, i);\n  };\n  var o = e.utils.removeUndefined;\n  return function (e) {\n    function n(i) {\n      var t = e.call(this, i) || this;\n      return t.opts = Object.assign({}, {\n        suggestion: !1\n      }, o(i)), t.messageDisplayedHandler = t.onMessageDisplayed.bind(t), t;\n    }\n    return function (e, i) {\n      if (\"function\" != typeof i && null !== i) throw new TypeError(\"Class extends value \" + String(i) + \" is not a constructor or null\");\n      function o() {\n        this.constructor = e;\n      }\n      _t(e, i), e.prototype = null === i ? Object.create(i) : (o.prototype = i.prototype, new o());\n    }(n, e), n.prototype.install = function () {\n      this.opts.suggestion && this.core.on(\"plugins.message.displayed\", this.messageDisplayedHandler);\n      this.core.registerPlugin(n.ALIAS_PLUGIN, new i.Alias({\n        mailgun: \"remote\"\n      })).addField(this.opts.field, {\n        validators: {\n          mailgun: {\n            crossDomain: !0,\n            data: {\n              api_key: this.opts.apiKey\n            },\n            headers: {\n              \"Content-Type\": \"application/json\"\n            },\n            message: this.opts.message,\n            name: \"address\",\n            url: \"https://api.mailgun.net/v3/address/validate\",\n            validKey: \"is_valid\"\n          }\n        }\n      });\n    }, n.prototype.uninstall = function () {\n      this.opts.suggestion && this.core.off(\"plugins.message.displayed\", this.messageDisplayedHandler), this.core.deregisterPlugin(n.ALIAS_PLUGIN), this.core.removeField(this.opts.field);\n    }, n.prototype.onEnabled = function () {\n      this.core.enableValidator(this.opts.field, \"mailgun\").enablePlugin(n.ALIAS_PLUGIN);\n    }, n.prototype.onDisabled = function () {\n      this.core.disableValidator(this.opts.field, \"mailgun\").disablePlugin(n.ALIAS_PLUGIN);\n    }, n.prototype.onMessageDisplayed = function (e) {\n      this.isEnabled && e.field === this.opts.field && \"mailgun\" === e.validator && e.meta && e.meta.did_you_mean && (e.messageElement.innerHTML = \"Did you mean \".concat(e.meta.did_you_mean, \"?\"));\n    }, n.ALIAS_PLUGIN = \"___mailgunAlias\", n;\n  }(e.Plugin);\n});\n\n//# sourceURL=webpack://Vuexy/./src/libs/@form-validation/umd/plugin-mailgun/index.min.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/libs/@form-validation/umd/plugin-mailgun/index.min.js");
/******/ 	
