...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=dod.database.windows.net;Initial Catalog=ExaminationDB;Persist Security Info=True;User ID=DOD;Password=Dawood@72;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.Property(e => e.StaffSsn).ValueGeneratedNever();
            entity.Property(e => e.HiringDate).HasDefaultValueSql("(getdate())");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.ImageUrl).HasDefaultValue("https://t3.ftcdn.net/jpg/05/87/76/66/360_F_587766653_PkBNyGx7mQh9l1XXPtCAq1lBgOsLl6xH.jpg");
